...
OUTPUT="$(echo "$TAIL")"
if [[ $OUTPUT == *"failed"* && $3 == "master" ]]; then
...
curl -X POST --data-urlencode "payload={'channel': '#platformsh', 'username': 'Behat Bot', 'icon_emoji': ':postbox:', 'attachments':[{'color':'warning', 'text': '*Target Website*: $1 \n *Target Environment*: $2 \n *Target Branch*: $3 \n *Result*: \n ${OUTPUT}'}]}" https://hooks.slack.com/services/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
fi
